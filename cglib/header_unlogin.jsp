...
<head>
	...
	<div class="head_top">
		<ul class="head_top_wel">
			<li>积分商城欢迎您</li>
			<li>|</li>
			<li><a href="/login_basic.shtml" class="js-login">登录</a></li>
			<li>|</li>
			<li><a href="/to_register_info.shtml">注册</a></li>
			<li>|</li>
			<li><span>【${sessionScope.city}】</span><a href="/to_change_city.shtml">切换城市</a></li>
		</ul>
		</ul>
