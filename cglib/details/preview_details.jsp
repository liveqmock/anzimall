	...
	<div class="mainbox cs">
		...
		<div class="details_msg cs">
			<div class="details_location">
				...
				<span><a href="/get_moreall.shtml?tid=${goodsmap.tid}" target="_blank">查看更多同类商品>></a></span>
			...
			<div class="info">
				...
				<cite>
					...
					现价：<strong>0</strong>元+<strong>${goodsmap.integral }</strong>积分 
					<span><em>0</em>人已兑换<br>数量有限，赶快下单吧！</span>
				</cite>
			</div>
			...
			<div class="sidebar">
				...
				<ul>
					...
					<li>
						...
						<cite>
							<strong>0</strong>元+<strong>${goods.integral }</strong>积分 
