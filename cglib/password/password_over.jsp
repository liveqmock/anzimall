...
<%
	...
	request.setAttribute("js","global");
...
%>
	...
	<!--<span>我记起来了，马上<a href="/login_basic.shtml">登录</a>/<a href="/index.html">返回首页</a></span>-->
			...
			<div class="register_steps"><img src="/images/register_steps3.png" alt=""></div>


			<p style="padding:150px 0;text-align:center;font-size: 16px;">
				<img src="images/success.png" alt="" style="vertical-align: middle;">
				恭喜您，密码成功设置！您可以使用新密码登录积分商城！<br><span class="backtohome">5</span>秒后跳转到<a href="#" style="color:#f00;">首页</a>

				<br><a href="/login_basic.shtml" style="display: inline-block;margin-top:30px; background:#ee450a;padding:5px 10px;color:#fff;">立即登录</a>
			</p>
