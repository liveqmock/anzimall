...
<div class="main">
	...
	<div class="content">
		<h4 class="tit"><b></b>积分使用明细
			<a href="/user_integralproduce.shtml" style="background:#fe6c6d;top:56px;">查看积分获得明细</a>
		</h4>

		<form class="fukrm fukrm_small" action="/user_integraldeductionbycondition.shtml" method="post">
			...
			<table border="0" cellspacing="0" cellpadding="0">
				...
				<c:forEach var="list" items="${pageSupport.result}" varStatus="index" begin="${pageSupport.currentPageNo*pageSupport.pageSize-pageSupport.pageSize}" end="${pageSupport.currentPageNo*pageSupport.pageSize-1}">
					<tr <c:if test="${index.count%2 != 1}">style="background:#fafafa"</c:if>>
						...
						<td>${list.deductionintegral}</td>
						<td><font color="#ee2323" font-size="20px;">${list.discountmoney}</font></td>
					</tr>
				</c:forEach>
